			...
			<form action="" method="post">
				...
				<table class="form-table sc-advanced-mode-table <?php if ( ! empty( $config['advanced_mode'] ) ) : ?>show<?php endif; ?>">
					<tbody>
						...
						<tr>
							<th scope="row"><label for="sc_enable_rest_api_cache"><?php esc_html_e( 'Cache REST API', 'simple-cache' ); ?></label></th>
							<td>
						...
						<tr>
							<th scope="row"><label for="sc_restore_headers"><?php esc_html_e( 'Restore Headers', 'simple-cache' ); ?></label></th>
							<td>
								<select <?php if ( empty( $config['advanced_mode'] ) ) : ?>disabled<?php endif; ?> name="sc_simple_cache[restore_headers]" id="sc_restore_headers">
									<option value="0"><?php esc_html_e( 'No', 'simple-cache' ); ?></option>
									<option <?php selected( $config['restore_headers'], true ); ?> value="1"><?php esc_html_e( 'Yes', 'simple-cache' ); ?></option>
								</select>
